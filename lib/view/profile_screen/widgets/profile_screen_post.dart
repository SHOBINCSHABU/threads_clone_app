...
class UserPostsContainer extends StatefulWidget {
  ...
  final bool isLiked;
  @override
  State<UserPostsContainer> createState() => _UserPostsContainerState();
}

class _UserPostsContainerState extends State<UserPostsContainer> {
  int currentPage = 1;
  @override
